    ...
    <main className="">
      <div>
        <div className="flex justify-between items-center">
          <h2 className="text-white text-[20px] font-bold">New Release</h2>
            ...
            >
              ...
              <div className="absolute bottom-2 left-4">
                ...
                <div className="sm:flex block gap-2 items-center opacity-0 group-hover:opacity-100 transition duration-300">
                  <p className="text-white text-[14px]">{release.category}</p>
                  <FontAwesomeIcon
                    className="h-1 w-1 text-white sm:block hidden"
                    icon={faCircle}
                  />
                  <p className="text-white text-[14px]">{release.duration}</p>
                </div>
              </div>
            </Link>
          </SwiperSlide>
